...
/**
 * @ClassName: ExecuteQueryDataHandler 
 * @Description: 执行数据库查询
 * @author yong.sun
 * @date 2013-9-23
 */
@Service
@Scope("prototype")
public class ExecuteQueryDataHandler extends AbstractBasicExecute implements IAjaxDataHandler {
	...
	public Map<String, Object> execute(String strData) {
		...
		try {
			...
			SqlCheck sqlCheck = check(sqlID, JSON2Java.optMap(objJson.get("parameters"), new HashMap<String, Object>()), user, application);
