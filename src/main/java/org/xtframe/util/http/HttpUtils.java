...
public class HttpUtils {
		...
		if (params != null && !params.isEmpty()) {
			...
			for (Map.Entry<String, String> entry : entrys) {
				buf.append(entry.getKey()).append("=")
						.append(URLEncoder.encode(entry.getValue(), "UTF-8").replaceAll("\\+", "%20"))
						.append("&");
			}
	...
	public static void main(String args[]) throws Exception {
		...
		params.put("age", "10");
		HttpURLConnection conn = (HttpURLConnection) sendGetRequest("http://127.0.0.1:8080/Server/PrintServlet", params, null);
