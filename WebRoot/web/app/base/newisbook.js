						...
						items : [{
							...
							handler : function() {
								...
								PubOPT.openPage({
									id: pgid,
									title: '最近新书信息添加',
									href: contextPath + '/p100094.html?ppid=' + PubOPT.getCurrentPageId()
								});
							}
						}, {
							btnCls : 'button button-small',
							...
							handler : function() {
								...
								PubOPT.openPage({
									id: pgid,
									title: '最近新书信息编辑',
									href: contextPath + '/p100094.html?ppid=' + PubOPT.getCurrentPageId() + '&code=' + model.tj_id 
								});
							}
						}, {
							btnCls : 'button button-small',
							...
							handler : function() {
									...
									buttons : [{
										...
										handler : function(){
											...
											for(var i=0; i<list.length; i++){
												sqllist.push({sqlID: "wx_recommend_5", parameters: {tj_id:list[i].tj_id}});   
											}
			                 ...
			                 content: '&nbsp;商品名称&nbsp;<input name="key" id="key" type="text" style="border:1px solid #999;width:200px;"/>'
						}, {
							btnCls : 'button button-small',
