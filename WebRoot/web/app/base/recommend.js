						...
						items : [{
							...
							handler : function() {
								...
								PubOPT.openPage({
									id: pgid,
									title: '畅销推荐信息添加',
									href: contextPath + '/p100092.html?ppid=' + PubOPT.getCurrentPageId()
								});
							}
						}, {
							btnCls : 'button button-small',
							...
							handler : function() {
								...
								PubOPT.openPage({
									id: pgid,
									title: '畅销推荐信息编辑',
									href: contextPath + '/p100092.html?ppid=' + PubOPT.getCurrentPageId() + '&code=' + model.tj_id 
								});
							}
						}, {
							btnCls : 'button button-small',
