...
<html>
	<head>
		...
		<title>${model._config.getString("sys_name")}</title>
	...
	<div class="topbg">
	   <div class="top_left">
	   	   <div class="logo">${model._config.getString("sys_name")}</div>
	   </div>
	   <div class="top_right">
	       <span>
	...
	BUI.use('common/main',function(){
		...
		config.unshift({
			...
			menu:[{
				text:'首页内容',
				items:[
					{id:'indexHome',text:'首　　页',href:'${model._contextPath}/p110002.html',closeable : false}
				]
			}]
		});
