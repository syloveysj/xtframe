...
<html>
	...
	<body>
		<div id="viewDialog" class="hide">
			<img id="viewImg" style="max-width:770px; max-height:460px;"/>
		</div>
		...
		<script type="text/javascript" src="${model._contextPath}/web/frame/workflow/wf_history_task_list.js"></script>
	</body>
</html>