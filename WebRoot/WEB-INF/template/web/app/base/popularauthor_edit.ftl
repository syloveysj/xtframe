...
<html>
	...
	<body>
				...
				<form id="J_Form" class="form-horizontal">
					...
					<div class="row">
						<div class="control-group">
							<label class="control-label"><s>*</s>人气作者：</label>
							<div class="controls span12">
								<input type="hidden" id="author_id" />
								<input type="text" id="author_name" name="author_name" data-rules="{required:true}" readonly="readonly" style="width:225px">
								<button type="button" id="but_author_id" class="button button-small"><i class="icon-search"></i>选择</button>
							</div>
						</div>
					</div>
					<div class="row">
		...
		<br><br>
		<div id="author_idDialog" class="hide">
			<div id="author_idGrid"></div>
		</div>
		...
		<script type="text/javascript" src="${model._contextPath}/web/app/base/popularauthor_edit.js"></script>
	</body>
</html>